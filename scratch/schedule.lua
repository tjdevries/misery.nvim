...
-- upside({ timeout = 15 * 1000 }, scheduler.add_task)
-- hide_cursor({ timeout = 15 * 1000 }, scheduler.add_task)
...
-- vsc_de({ timeout = 5 * 1000, user = { display = "teej" } }, scheduler.add_task)
-- no_going_back({ timeout = 30 * 1000 }, scheduler.add_task)
print("hello world")
